(function($){
    ...
    $(document).ready(function(){
        ...
        $(document).find('.ays-survey-reset-styles-button').on("click", function(e){
            ...
            $(document).find("#ays_survey_title_alignment,#ays_survey_title_alignment_mobile,#ays_survey_section_title_alignment,#ays_survey_section_description_alignment,#ays_survey_question_title_alignment,#ays_survey_answers_view_alignment,#ays_survey_buttons_alignment").aysDropdown('set selected', 'left');
            // Title font size
