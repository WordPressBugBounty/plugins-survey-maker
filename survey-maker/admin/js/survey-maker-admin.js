...
//            }, 100 );
        ...
        $(document).on('click', '.ays-survey-youtube-placeholder', function() {
...
function surveyCopyToClipboard(text) {
    if (navigator.clipboard && window.isSecureContext) {
        navigator.clipboard.writeText(text).then(function() {
            surveyShowCopyNotification(SurveyMakerAdmin.successCopyCoupon);
        }).catch(function() {
...
function fallbackCopyTextToClipboard(text) {
    ...
    try {
        ...
        if (successful) {
            ...
            surveyShowCopyNotification(SurveyMakerAdmin.failedCopyCoupon);
        }
    } catch (err) {
        surveyShowCopyNotification(SurveyMakerAdmin.failedCopyCoupon);
    }
...
function surveyShowCopyNotification(message) {
    var notification = document.createElement("div");
    notification.className = "ays-survey-copy-notification show";
