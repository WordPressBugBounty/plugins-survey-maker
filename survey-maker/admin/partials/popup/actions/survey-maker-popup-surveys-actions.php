                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        <label for="ays_popup_survey_height">
                            ...
                            <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__("Specify the height of your popup in pixels or percentage.","survey-maker"); ?>">
                                <i class="ays_fa ays_fa_info_circle"></i>
                            </a>
                        </label>
                    </div>
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col-sm-2">
                                <label for='ays_popup_survey_height'>
                                    <?php echo esc_html__('On desktop', "survey-maker"); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Specify the height of your popup in pixels or percentage for desktop devices.',"survey-maker")?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            <div class="col-sm-10 ays_survey_display_flex_width">
                                ...
                                <div class="ays_dropdown_max_width">
                                    <select id="ays_popup_survey_height_by_percentage_px" name="ays_popup_survey_height_by_percentage_px" class="ays-text-input ays-text-input-short ays_survey_aysDropdown" style="display:inline-block; width: 60px;">
                                        <option value="pixels" <?php echo $popup_survey_height_by_percentage_px == "pixels" ? "selected" : ""; ?>>px</option>
                                        <option value="percentage" <?php echo $popup_survey_height_by_percentage_px == "percentage" ? "selected" : ""; ?>>%</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <label for='ays_popup_survey_height_mobile'>
                                    <?php echo esc_html__('On mobile', "survey-maker"); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__('Specify the height of your popup in pixels or percentage for mobile devices.',"survey-maker")?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                            <div class="col-sm-10 ays_survey_display_flex_width">
                                ...
                                <div class="ays_dropdown_max_width">
                                    <select id="ays_popup_survey_height_mobile_by_percentage_px" name="ays_popup_survey_height_mobile_by_percentage_px" class="ays-text-input ays-text-input-short ays_survey_aysDropdown" style="display:inline-block; width: 60px;">
                                        <option value="pixels" <?php echo $popup_survey_height_mobile_by_percentage_px == "pixels" ? "selected" : ""; ?>>px</option>
                                        <option value="percentage" <?php echo $popup_survey_height_mobile_by_percentage_px == "percentage" ? "selected" : ""; ?>>%</option>
                                    </select>
                                </div>
                            </div>
                        </div>
