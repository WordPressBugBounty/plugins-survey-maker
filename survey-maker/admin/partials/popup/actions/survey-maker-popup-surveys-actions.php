            ...
            <div id="tab1" class="ays-survey-tab-content ays-survey-tab-content-active">
                ...
                <div class="form-group row ays_toggle_parent">
                    ...
                    <div class="col-sm-8 ays_toggle_target ays_divider_left <?php echo $survey_popup_enable_show_title ? '' : 'display_none_not_important'; ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2">
                                <label for="ays-survey-title-alignment-on-mobile">
                                    <?php echo __('Text alignment on mobile',"survey-maker")?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the text alignment of the popup title on mobile devices.',"survey-maker"); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        </div><!-- Popup title alignment on mobile -->
                        <hr/>
                        <div class="form-group row">
                            <div class="col-sm-2">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2">
                                <label for='ays_survey_popup_title_letter_spacing_on_mobile'>
                                    <?php echo __('Letter spacing on mobile', "survey-maker"); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the survey popup title in pixels for mobile devices.',"survey-maker"); ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        </div><!-- Popup title letter spacing on mobile -->
                        <hr/>
                        <div class="form-group row">
                            <div class="col-sm-2">
