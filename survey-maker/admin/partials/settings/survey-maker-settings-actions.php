...
class Survey_Maker_Settings_Actions {
    ...
    public function store_data(){
        ...
        if( isset($_REQUEST["settings_action"]) && wp_verify_nonce( sanitize_text_field( $_REQUEST["settings_action"] ), 'settings_action' ) ){
            ...
            $survey_popups_title_length = (isset($_REQUEST[$name_prefix . 'survey_popups_title_length']) && $_REQUEST[$name_prefix . 'survey_popups_title_length'] != '') ? absint( sanitize_text_field( $_REQUEST[$name_prefix . 'survey_popups_title_length'] ) ) : 5;
            ...
            $options = array(
                ...
                "survey_popups_title_length"                    => $survey_popups_title_length,
            ...
            $fields['default_texts'] = $default_texts;
