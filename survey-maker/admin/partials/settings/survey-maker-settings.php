<?php
    ...
    $survey_answer_default_count = (isset($options['survey_answer_default_count']) && $options['survey_answer_default_count'] != '')? $options['survey_answer_default_count'] : 3;
    ...
    $message_variables = array(        
        'general_message_variables'         => array(
            ...
            'post_author_website_url'                       => __('The website url of the author of the post.' , "survey-maker"),   
            'post_author_roles'                             => __('The role(s) of the author of the post when logged-in. In case the user is not logged-in, the field will be empty.' , "survey-maker"),
        ...
        'user_message_variables' => array(
            ...
            'user_registered'                               => __('The user\'s registration date when logged-in. In case the user is not logged-in, the field will be empty.' , "survey-maker"),
            ...
            'user_website_url'                              => __('The user\'s website url that was filled in their WordPress profile.' , "survey-maker"),
        ...
        'survey_message_variables' => array(
            ...
            'survey_category_title'                         => __('The title of the survey category.' , "survey-maker"),
            ...
            'current_survey_author_nickname'                => __('It will show the author nickname of the current survey.' , "survey-maker"),  
            'current_survey_author_display_name'            => __('It will show the author display name of the current survey.' , "survey-maker"),  
            'current_survey_author_website_url'             => __('It will show the author Website URL of the current survey.' , "survey-maker"),   
            'current_survey_author_registered'              => __('It will show the author registration date of the current survey.' , "survey-maker"), 
            'current_survey_page_link'                      => __('Prints the webpage link where the current survey is posted.' , "survey-maker"),  
            'current_survey_page_title'                     => __('Prints the webpage title where the current survey is posted.' , "survey-maker"),  
    ...
    <div class="container-fluid">
        <div class="ays-survey-heading-box">
            <div class="ays-survey-wordpress-user-manual-box">
                <a href="https://ays-pro.com/wordpress-survey-maker-user-manual#frag_general_settings" target="_blank" style="text-decoration: none;font-size: 13px;">
                    <i class="ays_fa ays_fa_file_text" ></i> 
                    <span style="margin-left: 3px;text-decoration: underline;"><?php echo esc_html__( "How to configure general settings", "survey-maker" ); ?></span>
                </a>
            </div>
        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <blockquote class="ays_warning" style="margin-top: 8px">
                                            <p style="margin:0;"><?php echo esc_html__( "Note: The text must include the %s sign (that is the name of the survey the user passed) in it. Otherwise, the default text will be displayed.", "survey-maker" ); ?></p>
                                        </blockquote>
                                    </div>
                                </div>
                            </div>
