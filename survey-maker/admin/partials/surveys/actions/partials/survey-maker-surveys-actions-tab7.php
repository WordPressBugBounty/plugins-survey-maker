                    ...
                    <div class='row'>
                        <div class="col-sm-3">
                            <label for="ays_survey_summary_single_email_to_users">
                                <?php echo __('Send submission report', "survey-maker"); ?>
                                <a class="ays_help ays-survey-zindex-for-pro" data-toggle="tooltip" title="<?php echo __('After enabling this option the user will receive the submissions report for the survey.',"survey-maker"); ?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            </label>
                        ...
                        <div class="col-sm-7 ays_divider_left">
                            <div class="form-group">
                                <label for="ays_survey_user_email_submission_summary" class="checkbox_ays form-check form-check-inline">
                                    ...
                                    <?php echo __('Summary',"survey-maker"); ?>
                                </label>
                                <label for="ays_survey_user_email_submission_individual" class="checkbox_ays form-check form-check-inline">
                                    ...
                                    <?php echo __('Individual',"survey-maker"); ?>
                                </label>
                                <a class="ays_help ays-survey-zindex-for-pro" style="font-size:15px;" data-toggle="tooltip" data-html="true"
                                    title="<?php
                                        echo "<p>". __('Choose your preferred method.', "survey-maker") . "</p>" .
                                        "<div>".
                                            "<p>". __('By Summary - Send the summary of all the answers the same user provided for the given survey.', "survey-maker") ."</p>".
                                            "<p>". __("By Individual - Send the results of the user's current submission.", "survey-maker") ."</p>".
                                        "</div>";
                                    ?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5">
                                    <label for="ays_survey_user_email_hide_sections">
                                        <?php echo __('Hide sections skipped by Logic Jump',"survey-maker")?>
                                        <a class="ays_help ays-survey-zindex-for-pro" data-toggle="tooltip" title="<?php echo __('Tick this option, and the sections that are skipped by the survey takers when the Logic Jump is enabled, will NOT BE included in the email content. If the option is disabled, all the sections will be included in the email content sent to the users.',"survey-maker"); ?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="form-group">
                                <blockquote>
                                    <?php
                                        echo sprintf(
                                            __( '%s Note: %s - If you choose the Summary option and the users take the survey as a guest, the email content sent to them will be the same as in the case of choosing the Individual option.', "survey-maker" ),
                                            '<b>',
                                            '</b>',
                                            '.'
                                        );
