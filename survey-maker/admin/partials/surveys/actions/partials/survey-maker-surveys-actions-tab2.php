<div id="tab2" class="ays-survey-tab-content <?php echo ($ays_tab == 'tab2') ? 'ays-survey-tab-content-active' : ''; ?>">
        ...
        <div class="col-lg-7 col-sm-12">
            <div class="ays-survey-collapsible-container">
                <div class="ays-survey-collapse-options">
                    ...
                    <div><p style="margin:0;font-size: 18px;font-weight: 500;"><?php echo __('Survey styles',"survey-maker"); ?></p></div>
                </div>
                <hr/>
                <div class="ays-survey-collapsible-options">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7 ays_divider_left">
                            <input type="text" class="ays-text-input" id='ays_survey_loader_color' data-alpha="true"name='ays_survey_loader_color' value="<?php echo $survey_loader_color; ?>"/>
                        </div>
                    </div> <!-- Loader Color -->
                    <hr/>
                    <div class="form-group row">
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_title_font_size'>
                                        ...
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the alignment of the survey title for desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_title_alignment_mobile'>
                                        ...
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the survey title alignment for Mobile devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                                <div class="col-sm-7 ays_survey_display_flex_width">
                                    <select class="ays-text-input ays-text-input-short ays_survey_aysDropdown" id='<?php echo esc_attr($html_name_prefix); ?>survey_title_alignment' name='<?php echo esc_attr($html_name_prefix); ?>survey_title_alignment_mobile'>
                                        <option value="left"   <?php echo ($survey_title_alignment_mobile == 'left')   ? 'selected' : ''; ?>><?php echo __('Left',"survey-maker"); ?></option>
                                        <option value="center" <?php echo ($survey_title_alignment_mobile == 'center') ? 'selected' : ''; ?>><?php echo __('Center',"survey-maker"); ?></option>
                                        <option value="right"  <?php echo ($survey_title_alignment_mobile == 'right')  ? 'selected' : ''; ?>><?php echo __('Right',"survey-maker"); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-7 ays_divider_left">
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_title_font_size'>
                                        <?php echo __('On desktop', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the font size of the survey title for desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-5">
                            <label for='ays_survey_title_letter_spacing'>
                                <?php echo __('Survey title letter spacing', "survey-maker"); ?>
                                <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the survey title in pixels.',"survey-maker"); ?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            </label>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>ays_survey_title_letter_spacing'>
                                        <?php echo __('On desktop', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the survey title in pixels desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>ays_survey_title_letter_spacing_mobile'>
                                        <?php echo __('On mobile', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the survey title in pixels for mobile devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                        ...
                        <div class="col-sm-7 ays_divider_left">
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_section_title_font_size'>
                                        <?php echo __('On desktop', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the font size of the survey section title for desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7 ">
                                    <select class="ays-text-input ays-text-input-short ays_survey_aysDropdown" id='<?php echo esc_attr($html_name_prefix); ?>survey_section_title_alignment_mobile' name='<?php echo esc_attr($html_name_prefix); ?>survey_section_title_alignment_mobile'>
                                        <option value="left"   <?php echo ($survey_section_title_alignment_mobile == 'left')   ? 'selected' : ''; ?>><?php echo __('Left',"survey-maker"); ?></option>
                                        <option value="center" <?php echo ($survey_section_title_alignment_mobile == 'center') ? 'selected' : ''; ?>><?php echo __('Center',"survey-maker"); ?></option>
                                        <option value="right"  <?php echo ($survey_section_title_alignment_mobile == 'right')  ? 'selected' : ''; ?>><?php echo __('Right',"survey-maker"); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-5">
                            <label for='ays_survey_section_title_letter_spacing'>
                                <?php echo __('Survey section title letter spacing', "survey-maker"); ?>
                                <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the survey section title in pixels.',"survey-maker"); ?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            </label>
                        </div>
                        ...
                        <div class="col-sm-7 ays_divider_left">
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_section_description_font_size'>
                                        <?php echo __('On desktop', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the font size of the section description for desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-5">
                            <label for='ays_survey_section_description_letter_spacing'>
                                <?php echo __('Survey section description letter spacing', "survey-maker"); ?>
                                <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the survey section description in pixels.',"survey-maker"); ?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            </label>
                        </div>
                        <div class="col-sm-7 ays_divider_left">
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_section_description_font_size'>
                                        <?php echo __('On desktop', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the survey section description in pixels desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_section_description_letter_spacing_mobile'>
                                        <?php echo __('On mobile', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the survey section description in pixels for moblie devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
            ...
            <div class="ays-survey-collapsible-container">
                <div class="ays-survey-collapse-options">
                    <div><i class="ays_fa ays_fa_arrow_down ays-survey-collapse-options-button" data-rotation="false" style="font-size: 15px;"></i></div>
                    <div><p style="margin:0;font-size: 18px;font-weight: 500;"><?php echo __('Question styles',"survey-maker"); ?></p></div>
                </div>
                <hr/>
                <div class="ays-survey-collapsible-options">
                    <div class="form-group row">
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_question_padding'>
                                        <?php echo __('On desktop', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the padding of the survey questions box in pixels desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_question_padding_mobile'>
                                        <?php echo __('On mobile', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the padding of the survey questions box in pixels for moblie devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_question_caption_text_alignment'>
                                        <?php echo __('On desktop', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the alignment of the question caption texts for desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_question_caption_text_alignment_on_mobile'>
                                        <?php echo __('On mobile', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the alignment of the question caption texts for mobile devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                                <div class="col-sm-7 ays_survey_display_flex_width">
                                    <select class="ays-text-input ays-text-input-short ays_survey_aysDropdown" id="ays_survey_question_caption_text_alignment_on_mobile" name="ays_survey_question_caption_text_alignment_on_mobile">
                                        <option value="left"   <?php echo ($survey_question_caption_text_alignment_on_mobile == 'left')   ? 'selected' : ''; ?>><?php echo __('Left',"survey-maker"); ?></option>
                                        <option value="center" <?php echo ($survey_question_caption_text_alignment_on_mobile == 'center') ? 'selected' : ''; ?>><?php echo __('Center',"survey-maker"); ?></option>
                                        <option value="right"  <?php echo ($survey_question_caption_text_alignment_on_mobile == 'right')  ? 'selected' : ''; ?>><?php echo __('Right',"survey-maker"); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_answers_gap'>
                                        <?php echo __('On desktop', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the font size of the question caption texts for desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>ays_survey_buttons_alignment_mobile'>
                                        <?php echo __('On mobile', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the font size of the question caption texts for mobile devices.', "survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-5">
                            <label for='ays_survey_question_caption_letter_spacing'>
                                <?php echo __('Question caption letter spacing', "survey-maker"); ?>
                                <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the question caption in pixels.',"survey-maker"); ?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            </label>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-5">
                            <label for='ays_survey_question_caption_hide_on_mobile'>
                                <?php echo __('Question caption hide on mobile', "survey-maker"); ?>
                                <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Tick this option to hide the caption text on mobile devices.',"survey-maker"); ?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            </label>
                        </div>
            ...
            <div class="ays-survey-collapsible-container">
                <div class="ays-survey-collapse-options">
                    <div><i class="ays_fa ays_fa_arrow_down ays-survey-collapse-options-button" data-rotation="false" style="font-size: 15px;"></i></div>
                    <div><p style="margin:0;font-size: 18px;font-weight: 500;"><?php echo __('Answer styles',"survey-maker"); ?></p></div>
                </div>
                <hr/>
                <div class="ays-survey-collapsible-options">
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-5">
                            <label for='ays_survey_answer_letter_spacing'>
                                <?php echo __('Answer letter spacing', "survey-maker"); ?>
                                <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the answer in pixels.',"survey-maker"); ?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            </label>
                        </div>
                        <div class="col-sm-7 ays_divider_left">
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_answer_letter_spacing'>
                                        <?php echo __('On desktop', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the answer in pixels desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_answer_letter_spacing_mobile'>
                                        <?php echo __('On mobile', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the answer in pixels for mobile devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                        ...
                        <div class="col-sm-7 ays_divider_left">
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_answer_letter_spacing'>
                                        <?php echo __('On desktop', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the distance between the text and the border of the answer box in pixels for desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_answer_letter_spacing_mobile'>
                                        <?php echo __('On mobile', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the distance between the text and the border of the answer box in pixels for mobile devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                        ...
                        <div class="col-sm-7 ays_divider_left">
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_answers_image_size'>
                                        <?php echo __('On desktop', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the size of answers image in pixels for desktop devices.',"survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for='<?php echo esc_attr($html_name_prefix); ?>survey_answers_gap_mobile'>
                                        <?php echo __('On mobile', "survey-maker"); ?>
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the size of answers image in pixels for mobile devices.', "survey-maker")?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
    ...
    <div class="ays-survey-collapsible-container">
        <div class="ays-survey-collapse-options">
            <div><i class="ays_fa ays_fa_arrow_down ays-survey-collapse-options-button" data-rotation="false" style="font-size: 15px;"></i></div>
            <div><p style="margin:0;font-size: 18px;font-weight: 500;"><?php echo __('Button  styles',"survey-maker"); ?></p></div>
        </div>
        <hr/>
        <div class="ays-survey-collapsible-options">
                ...
                <div class="form-group row">
                    <div class="col-sm-5">
                        <label for='ays_survey_buttons_font_size'>
                            ...
                            <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the alignment of the buttons.',"survey-maker"); ?>">
                                <i class="ays_fa ays_fa_info_circle"></i>
                            </a>
                        </label>
                    </div>
                    <div class="col-sm-7 ays_divider_left">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <label for='<?php echo esc_attr($html_name_prefix); ?>ays_survey_buttons_alignment_mobile'>
                                    <?php echo __('On mobile', "survey-maker"); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the alignment of the buttons for mobile devices.', "survey-maker")?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-5">
                        <label for='ays_survey_buttons_text_letter_spacing'>
                            <?php echo __('Buttons text letter spacing', "survey-maker"); ?>
                            <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the survey buttons texts in pixels.',"survey-maker"); ?>">
                                <i class="ays_fa ays_fa_info_circle"></i>
                            </a>
                        </label>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <label for='<?php echo esc_attr($html_name_prefix); ?>survey_title_letter_spacing'>
                                    <?php echo __('On desktop', "survey-maker"); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the survey buttons texts in pixels desktop devices.',"survey-maker")?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <label for='<?php echo esc_attr($html_name_prefix); ?>survey_buttons_text_letter_spacing_mobile'>
                                    <?php echo __('On mobile', "survey-maker"); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Define the space between the letters of the survey buttons texts in pixels for mobile devices.',"survey-maker")?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
