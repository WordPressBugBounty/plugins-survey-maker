<div id="tab2" class="ays-survey-tab-content <?php echo ($ays_tab == 'tab2') ? 'ays-survey-tab-content-active' : ''; ?>">
        ...
        <div class="col-lg-7 col-sm-12">
            <div class="ays-survey-collapsible-container">
                <div class="ays-survey-collapse-options">
                    ...
                    <div><p style="margin:0;font-size: 18px;font-weight: 500;"><?php echo esc_html__('Survey styles',"survey-maker"); ?></p></div>
                </div>
                <hr/>
            ...
            <div class="ays-survey-collapsible-container">
                <div class="ays-survey-collapse-options">
                    <div><i class="ays_fa ays_fa_arrow_down ays-survey-collapse-options-button" data-rotation="false" style="font-size: 15px;"></i></div>
                    <div><p style="margin:0;font-size: 18px;font-weight: 500;"><?php echo esc_html__('Question styles',"survey-maker"); ?></p></div>
                </div>
                <hr/>
                <div class="ays-survey-collapsible-options">
                    <div class="form-group row">
            ...
            <div class="ays-survey-collapsible-container">
                <div class="ays-survey-collapse-options">
                    <div><i class="ays_fa ays_fa_arrow_down ays-survey-collapse-options-button" data-rotation="false" style="font-size: 15px;"></i></div>
                    <div><p style="margin:0;font-size: 18px;font-weight: 500;"><?php echo esc_html__('Answer styles',"survey-maker"); ?></p></div>
                </div>
                <hr/>
                <div class="ays-survey-collapsible-options">
                    <div class="form-group row">
    ...
    <div class="ays-survey-collapsible-container">
        <div class="ays-survey-collapse-options">
            <div><i class="ays_fa ays_fa_arrow_down ays-survey-collapse-options-button" data-rotation="false" style="font-size: 15px;"></i></div>
            <div><p style="margin:0;font-size: 18px;font-weight: 500;"><?php echo esc_html__('Button  styles',"survey-maker"); ?></p></div>
        </div>
        <hr/>
        <div class="ays-survey-collapsible-options">
