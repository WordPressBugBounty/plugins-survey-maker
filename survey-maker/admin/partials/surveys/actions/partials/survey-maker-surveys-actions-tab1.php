        ...
        <div class="col-sm-12 col-lg-11">
            ...
            <div class="form-group row">
                <div class="d-flex align-items-end justify-content-end w-100 h-100">
                    ...
                    <?php endif; ?>
                    <button type="button" class="button button-primary ays-survey-open-templates-modal"><?php echo __("Survey templates" , "survey-maker")?></button>
                    <a data-toggle="tooltip" title="<?php echo __('All the previously created questions from other surveys are collected in the Question Library. You can make use of them in your current survey.',"survey-maker");?>" href="https://ays-pro.com/wordpress/survey-maker" target="_blank" type="button" class="button button-primary" style="opacity: 0.5;margin-left: 12px;"><?php echo __( 'Questions library', "survey-maker" ); ?></a>
                    <a data-toggle="tooltip" title="<?php echo __('Import questions to your survey in the .xlsx file format. The file can include questions, answers and types.',"survey-maker");?>" href="#" type="button" class="button button-primary ays-survey-question-actions-pro-button" data-video-url="https://www.youtube.com/watch?v=l3iCnRzeUsQ" data-option-title="<?php echo __('Import Questions',"survey-maker")?>" data-option-text="If you already have the necessary questions for your survey and want <strong> to save time </strong>, use the “Import Questions” option. <strong> Import the. XLSX file </strong> with the questions, question types, and answers where needed into your survey dashboard and customize it according to your needs and desires. To better understand what formatting your. XLSX file requires <strong> download an example </strong> to avoid any confusion or difficulty.  " style="margin-left: 12px;opacity: 0.5;"><?php echo __("Import questions" ,  "survey-maker")?></a>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-12">
                                ...
                                <div class="ays-survey-question-answer-conteiner ays-survey-new-question" data-name="questions_add" data-id="1">
                                    ...
                                    <div class="ays-survey-question-wrap-expanded">
                                            ...
                                            <div class="ays-survey-question-row-wrap">
                                                <div class="ays-survey-question-row">
                                                    ...
                                                    <select name="<?php echo esc_attr($html_name_prefix); ?>section_add[1][questions_add][1][type]" tabindex="-1" class="ays-survey-question-type survey_default_type" aria-hidden="true" data-type="<?php echo esc_attr($survey_default_type);?>">
                                                        ...
                                                        <option value="time" disabled>Time (Pro)</option>
                                                    ...
                                                    <a href="https://ays-pro.com/blog/survey-question-types" target="_blank" class="ays-survey-view-all-question-types-button"><?php echo __('View all question types', "survey-maker"); ?></a>                                                    
                                                    <a href="https://www.youtube.com/watch?v=jyEXM28vx7I" target="_blank" class="ays-survey-view-all-question-types-button"><?php echo __('All question types (video guide)', "survey-maker"); ?></a>
                                                </div>
                                                </div>
                                                <div>
                                                    <div class="ays-survey-question-img-icon-box">
                                        ...
                                        <?php
                                                        ...
                                                        <div class="ays-survey-question-types-box isDisabled">
                                                            <div class="ays-survey-question-types-box-body">
                                                                <div class="ays-survey-answer-box ays_survey_date">
                                                                    <input type="text" autocomplete="off" tabindex="0" value="<?php echo __("Month, day, year", "survey-maker"); ?>" disabled="" dir="auto">
                                            ...
                                            <?php else :?>
                                            <div class="ays-survey-question-types">
                                                <div class="ays-survey-answer-row" data-id="1" <?php echo $survey_default_type == 'star' || $survey_default_type == 'date' ? 'style="display:none;"' : '' ;?>>
                                                    <div class="ays-survey-question-types-conteiner">
                                        ...
                                        <div class="ays-survey-other-answer-and-actions-row" <?php echo $survey_default_type == 'star' || $survey_default_type == 'date' ? 'style="display:none;"' : '' ;?>>
                                                ...
                                                <div class="ays-survey-answer-wrap">
                                                    ...
                                                    <div class="ays-survey-answer-box-wrap">
                                                        <div class="ays-survey-answer-box ays-survey-action-add-answer-box-main-new">
                                                            <div class="ays-survey-action-add-answer appsMaterialWizButtonPapericonbuttonEl ays-survey-action-add-answer-box-new" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="<?php echo __('Add option',"survey-maker")?>">
                                                                <div class="ays-question-img-icon-content">
                                                                    <div class="ays-question-img-icon-content-div">
                                                                        <div class="ays-survey-icons">
                                                    ...
                                                    <div class="ays-survey-answer-icon-box">
                                                        <div class="ays-survey-action-bulk-add-answer">
                                                            ...
                                                            <div class="ays-survey-action-bulk-add-answer-text">
                                                                <a href="https://ays-pro.com/wordpress/survey-maker" style="color: gray;" target="blank"><?php echo __('Bulk add',"survey-maker")?> (PRO)</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="ays-survey-answer-icon-box ays-survey-question-more-actions droptop">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <button type="button" class="dropdown-item ays-survey-question-action ays-survey-question-actions-pro" data-action="enable-user-explanation" style="font-style: italic;">
                                                            <a href="https://ays-pro.com/wordpress/survey-maker" target="_blank"><?php echo __( 'User explanation', "survey-maker" ); ?> (Pro) </a>
                                                        </button>
                                                        <button type="button" class="dropdown-item ays-survey-question-action ays-survey-question-actions-pro" data-action="disable-hide-results" style="font-style: italic;">
                                                            <a href="https://ays-pro.com/wordpress/survey-maker" target="_blank"><?php echo __( 'Hide results', "survey-maker" ); ?> (Pro) </a>
                                                        </button>
                                                        <button type="button" class="dropdown-item ays-survey-question-action ays-survey-question-actions-pro" data-action="enable-admin-note">
                                                            <a href="https://ays-pro.com/wordpress/survey-maker" target="_blank"><?php echo __( 'Admin note', "survey-maker" ); ?> (Pro) </a>
                                                        </button>
                                                        <button type="button" class="dropdown-item ays-survey-question-action ays-survey-question-actions-pro ays-survey-question-actions-pro-button" data-action="enable-url-parameter" data-video-url="https://www.youtube.com/watch?v=1nvOtwlmVAo" data-option-title="<?php echo __('URL parametr',"survey-maker")?>" data-option-text="The URL parameter is a great tool <strong> to help you collect and analyze your submission results easier. </strong> It is handy when you need to share your survey on various platforms to identify where the respondents came from. You can also use this feature when you know some information about your survey takers and want to save their time and ensure the accuracy of the survey. URL Parameter is more popular with the <strong> hidden question type </strong> because you can share the surveys with specific scenarios. For instance, if you need to send your survey to the Marketing and Development team employees, you can assign URL parameters, and it will be easier to track and analyze the results separately.  ">
                                                            <a href="#" ><?php echo __( 'URL parametr', "survey-maker" ); ?> (Pro) </a>
                                                        </button>
                                                        <button type="button" class="dropdown-item ays-survey-question-action ays-survey-question-actions-pro" data-action="enable-value-prefix">
                                                            <a href="https://ays-pro.com/wordpress/survey-maker" target="_blank"><?php echo __( 'Value prefix', "survey-maker" ); ?> (Pro) </a>
                                                        </button>
                                                        <button type="button" class="dropdown-item ays-survey-question-action ays-survey-question-actions-pro" data-action="enable-value-suffix">
                                                            <a href="https://ays-pro.com/wordpress/survey-maker" target="_blank"><?php echo __( 'Value suffix', "survey-maker" ); ?> (Pro) </a>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="ays-survey-question-answer-conteiner ays-survey-old-question" data-name="questions" data-id="<?php echo esc_attr($question['id']); ?>">
                                            ...
                                            <div class="ays-survey-question-wrap-expanded <?php echo $question['options']['collapsed'] == 'collapsed' ? 'display_none' : ''; ?>">
                                                ...
                                                <?php
                                                    ...
                                                    ?>
                                                    <!-- Answers start -->
                                                    <div class="ays-survey-answer-row" data-id="<?php echo esc_attr($answer['id']); ?>" <?php echo ($selected_question_type == 'date' || $selected_question_type == 'star') ? 'style="display:none;"' : '' ?>>
                                                        <div class="ays-survey-answer-wrap">
                                                            <div class="ays-survey-answer-dlg-dragHandle">
                                                                <div class="ays-survey-icons ays-survey-icons-hidden">
                                                                    <img src="<?php echo esc_attr(SURVEY_MAKER_ADMIN_URL); ?>/images/icons/dragndrop-vertical.svg">
                                                ...
                                                <?php
                                                    ...
                                                    <div class="ays-survey-answer-row" <?php echo $question['type'] == 'star' || $question['type'] == 'date' ? 'style="display:none;"' : '' ;?> >
                                                        <div class="ays-survey-answer-wrap">
                                                            <div class="ays-survey-answer-dlg-dragHandle" >
                                                                <div class="ays-survey-icons invisible">
                                                                    <img src="<?php echo esc_attr(SURVEY_MAKER_ADMIN_URL); ?>/images/icons/dragndrop-vertical.svg">
            ...
            <div class="aysFormeditorViewFatRoot aysFormeditorViewFatDesktop">
                <div class="aysFormeditorViewFatPositioner">
                    <div class="aysFormeditorViewFatCard">
                        ...
                        <div data-action="enable-answer-points" style="background-color: #3571c40d;" class="ays-survey-general-action" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="left" data-content="<?php echo __('Enable points for answers (PRO) ', "survey-maker")?>">
                            <div class="appsMaterialWizButtonPapericonbuttonEl ays-survey-icon-svg">
                                <a style="box-shadow: unset;outline: unset;" href="https://ays-pro.com/wordpress/survey-maker" target="_blank">
                                    <img src="<?php echo SURVEY_MAKER_ADMIN_URL; ?>/images/icons/pro-features-icons/number-1-O.svg" width="24" height="24">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="aysFormeditorViewFatRoot aysFormeditorViewFatMobile">
        <div class="aysFormeditorViewFatPositioner">
            <div class="aysFormeditorViewFatCard">
                ...
                <div class="ays-survey-general-action-max-inps-vars display_none" data-max-inp-vars="<?php echo esc_attr($survey_max_input_vars_server); ?>" data-action="save-changes" class="ays-survey-general-action" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="left" data-content="<?php echo __('lorem ipsimsak sdoasd kaskd alksd ak alkd sas a asdkasdjaksdxcv asdkskdjf nksldfv ',"survey-maker")?>">
                    <div class="appsMaterialWizButtonPapericonbuttonEl ays-survey-icon-svg">
                        <img src="<?php echo esc_attr(SURVEY_MAKER_ADMIN_URL); ?>/images/icons/warning.png">
                    </div>
                </div>
