            ...
            <div class="form-group row">
                <div class="col-sm-4">
                    <label for="ays_survey_show_summary_after_submission">
                        <?php echo __('Show results after submission',"survey-maker"); ?>
                    ...
                    <div class="form-group row ays-survey-show-current-user-results">
                        <div class="col-sm-5">
                            ...
                            <label for="ays_survey_show_current_user_results">
                                <?php echo __('Show only current user results',"survey-maker")?>
                                <a class="ays_help ays-survey-zindex-for-pro" data-toggle="tooltip" title="<?php echo __('Tick this option to show the users only their latest results.',"survey-maker"); ?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            </label>
            ...
            <div class="form-group row">
                <div class="col-sm-4">
                    <label for="ays_survey_enable_twitter_share_button" class="d-flex align-items-center" style="gap: 3px;">
                        ...
                        <?php echo __('X button',"survey-maker")?>
                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Display X social button so that the users can share the page on which your survey is posted.',"survey-maker"); ?>">
                            <i class="ays_fa ays_fa_info_circle"></i>
                        </a>
                    </label>
                </div>
