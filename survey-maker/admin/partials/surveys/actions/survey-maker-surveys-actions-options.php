<?php
    ...
    $survey_message_vars = array(
        ...
        '%%user_registered%%'                           => __('Users Registered', "survey-maker"),
        ...
        '%%user_website_url%%'                          => __('Users Website URL', "survey-maker"),
        ...
        '%%current_survey_author_nickname%%'            => __('Survey Author Nickname', "survey-maker"),
        '%%current_survey_author_display_name%%'        => __('Survey Author Display Name', "survey-maker"),
        '%%current_survey_author_website_url%%'         => __('Survey Author Website URL', "survey-maker"),
        '%%current_survey_author_registered%%'          => __('Survey Author Registered', "survey-maker"),
        '%%current_survey_page_link%%'                  => __('Survey Page Link', "survey-maker"),
        '%%current_survey_page_title%%'                 => __('Survey Page Title', "survey-maker"),
        ...
        '%%post_author_roles%%'                         => __('Post Author Roles', "survey-maker"),
    ...
    $survey_limitation_message_vars = array(
        '%%survey_title%%'                              => __('Survey Title', "survey-maker"),
        '%%survey_category_title%%'                     => __('Survey Category Title', "survey-maker"),
        '%%survey_id%%'                                 => __('Survey ID', "survey-maker"),
        '%%questions_count%%'                           => __('Questions Count', "survey-maker"),
        '%%current_time%%'                              => __('Current Time', "survey-maker"),
        '%%sections_count%%'                            => __('Sections Count', "survey-maker"),
