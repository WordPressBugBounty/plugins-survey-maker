 ...
 */
define( 'SURVEY_MAKER_VERSION', '5.2.2.8' );
            ...
            <div class="navigation-bar">
                <div id="navigation-container">                    
                    <div class="ays-survey-logo-container-upgrade ays-navigation-container-logo-updrade-box">
                        ...
                        <div class="ays-survey-top-banner-title">
                            <span class="ays-survey-top-banner-main-title"><?php echo esc_html__( "Survey Maker by AYS", 'survey-maker' ); ?></span>
                            <span class="ays-survey-top-banner-sub-title"><?php echo esc_html__( "Create online surveys quickly", 'survey-maker' ); ?></span>
                        </div>
                        <div class="ays-survey-upgrade-container">
                            <a class="ays-navigation-container-updrade-button-box" href="https://ays-pro.com/wordpress/survey-maker?utm_source=survey-maker-free&utm_medium=dashboard&utm_campaign=upgrade-button-<?php echo esc_attr(SURVEY_MAKER_VERSION); ?>#ays-pro-sm-plans-box-sg" target="_blank">
                            ...
                            <span class="ays-survey-logo-container-one-time-text"><?php echo esc_html__( "One-time payment", 'survey-maker' ); ?></span>
                        </div>                        
                    </div>
                    <ul id="menu">                        
