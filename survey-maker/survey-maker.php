 ...
 */
define( 'SURVEY_MAKER_VERSION', '5.1.6.9' );
                ...
                <div id="navigation-container">
                    ...
                    <div class="ays-navigation-container-logo-updrade-box">
                        ...
                        <div class="ays-survey-upgrade-container">
                            <a class="ays-navigation-container-updrade-button-box" href="https://ays-pro.com/wordpress/survey-maker?utm_source=survey-maker-free&utm_medium=dashboard&utm_campaign=upgrade-button-<?php echo esc_attr(SURVEY_MAKER_VERSION); ?>" target="_blank">
                        ...
                        <div class="ays-survey-coupon-container">
                            <div class="ays-survey-coupon-box ays-survey-copy-element-box-parent">
                                <span onClick="selectAndCopyElementContents(this)" class="ays-survey-copy-element-box" data-toggle="tooltip" title="<?php echo esc_html__( "Click for copy", 'survey-maker' ); ?>">spring2025</span>
                            </div>
