...
class Survey_Maker {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'admin_body_class', $plugin_admin, 'ays_survey_add_body_class' );
		...
		// Live preview
		$this->loader->add_action( 'wp_ajax_ays_survey_maker_live_preview_content', $plugin_admin, 'ays_survey_maker_live_preview_content' );
	...
	private function define_integrations_hooks() {
        ...
        // ===== Brevo integration =====
			// Brevo integration / settings page
			...
			// Brevo integration / survey page
			$this->loader->add_filter( 'ays_sm_survey_page_integrations_contents', $plugin_integrations, 'ays_survey_page_sendinblue_content', 1, 2 );
        // ===== Brevo integration =====
